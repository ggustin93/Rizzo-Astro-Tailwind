...
### Changed
- **Client UI corrections**: single separators between service sections, centered theme-colored service headers, compact mobile hero actions, restored team discovery button and clickable portraits on homepage and team listing. Decap labels now reflect the approved portrait-link behavior.
