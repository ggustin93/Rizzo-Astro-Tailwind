...
### Changed
- **Tablet/mobile homepage**: compact centered header, smaller landscape-tablet logo, side-by-side hero from 640 px, mobile type/illustration sizing and aligned touch actions; tighter tablet service-card spacing.
- **Contact experience (#19)**: compact four-action banner without redundant descriptions, title above the actions, rounded hover states, restrained illustration motifs and softer form shadow. Footer now shows the address and general email under “Contact” (FR/EN/NL) / “Contatti” (IT), replacing the initial “Our offices, address only” brief at Guillaume’s request. Individual phone/email menus removed from the footer.
- **Form and legal contacts**: recoverable submission errors and loading states; form visibility also controls its entry points. Cabinet contact details resolve centrally on legal pages and structured data. Local tests simulate submissions and calendars; actual CMS saving, mailbox activation (#24), Netlify delivery and client translation review remain prerequisites for production acceptance.
- **Client UI corrections**: single separators between service sections, centered theme-colored service headers, compact mobile hero actions, non-clickable team discovery label per the client PDF and clickable portraits on homepage and team listing. Decap labels now reflect the approved portrait-link behavior.
- **Homepage hero**: balanced text/illustration grid, readable subtitle with yellow accent, consistent turquoise/outline actions and mobile button sizing; existing content and illustration preserved.
- **Preview UI refinement (#12, #20)**: clearer homepage service cards, consistent team/profile layouts, improved text contrast, contextual icons and preserved audience colors. Service pages now include section navigation and keyboard-accessible native accordions, with an expanded/accordion display choice in Decap for every language. Profile headings follow H1/H2 structure; legal copy, metadata and structured data are preserved.
